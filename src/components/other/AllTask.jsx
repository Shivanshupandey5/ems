...
const AllTask = () => {
  ...
  return(
      <div className="bg-[#1c1c1c] p-4 sm:p-5 rounded mt-5 overflow-x-auto">
        {/* Header */}
        <div className="min-w-[600px] bg-red-400 mb-2 py-2 px-4 flex justify-between rounded">
        ...
        <div className="min-w-[600px]">
          {userData.map((elem, idx) => (
            ...
            >
              <h2 className="text-sm sm:text-lg font-medium w-1/5">
                {elem.firstName}
              </h2>
              <h3 className="text-sm sm:text-lg font-medium w-1/5 text-blue-400">
                {elem.taskCounts.newTask}
              </h3>
              <h5 className="text-sm sm:text-lg font-medium w-1/5 text-yellow-400">
                {elem.taskCounts.active}
              </h5>
              <h5 className="text-sm sm:text-lg font-medium w-1/5 text-white">
                {elem.taskCounts.completed}
              </h5>
              <h5 className="text-sm sm:text-lg font-medium w-1/5 text-red-600">
